...
;
          if (!runningTests) {
            require("army-builder/app")["default"].create({"name":"army-builder","version":"0.0.0+e3122537"});
          }
